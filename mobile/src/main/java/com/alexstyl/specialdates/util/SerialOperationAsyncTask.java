 ...
 * </p>
 */
public abstract class SerialOperationAsyncTask<Params, Progress, Result> {
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link SerialOperationAsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
     ...
     * UI thread.
     */
    public SerialOperationAsyncTask() {
     ...
     *             {@link SerialOperationAsyncTask.Status#RUNNING} or
     *             {@link SerialOperationAsyncTask.Status#FINISHED}.
     * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
     * @see #execute(Runnable)
     */
    public final SerialOperationAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     * @see #execute(Object[])
     */
    public final SerialOperationAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final SerialOperationAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(SerialOperationAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
