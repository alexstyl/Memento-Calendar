...
public class OpaqueAnimationDrawable extends Drawable implements Animatable {
    ...
    final private int opacque;

    public OpaqueAnimationDrawable(int opacque) {
        super();
        this.opacque = opacque;
    }
