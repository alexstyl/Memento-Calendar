...
class DateParserTest {
    ...
    fun dateWithSlashes() {
        ...
        assertThat(parsed).isEqualTo(dateOn(13, JANUARY, 1972))
    }
    ...
    fun longDate() {
        ...
        val parsed = dateParser.parse(dateDashes)
        assertThat(parsed).isEqualTo(dateOn(14, FEBRUARY, 1949))
    }
    ...
    fun longDate2() {
        ...
        val parsed = dateParser.parse(dateDashes)
        assertThat(parsed).isEqualTo(dateOn(26, OCTOBER, 2015))
    }
    ...
    fun datesWithDashes() {
        ...
        val parsed = dateParser.parse(dateDashes)
        assertThat(parsed).isEqualTo(dateOn(29, MARCH, 2016))
    }
    ...
    fun datesWithDashesWithoutYear() {
        ...
        val parsed = dateParser.parse(dateDashes)
        assertThat(parsed).isEqualTo(dateOn(29, MARCH))
    }
    ...
    fun noYear_on_29th_Of_February() {
        ...
        val parsed = dateParser.parse(dateDashes)
        assertThat(parsed).isEqualTo(dateOn(29, FEBRUARY))
    }
